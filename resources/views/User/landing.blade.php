...
@section('content')
      ...
      <div class="container">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            ...
            <p class="mt-0 italic text-white">Pengaduan Masyarakat</p>
          </a>
  ...
  <div class="text-center">
    <h2 class="medium mt-3 text-white">Layanan Pengaduan Masyarakat</h2>
    <p class="mb-5 italic text-white">Sampaikan laporan Anda langsung kepada yang pemerintah berwenang</p>
  </div>
...
<div class="pengaduan mt-5">
  <div class="bg-purple">
    <div class="text-center">
      <h5 class="medium mt-3 text-white">JUMLAH LAPORAN SEKARANG</h5>
...
<div class="mt-5">
  <hr>
  <div class="text-center">
    <p class="text-secondary italic">© 2021 Ihsanfrr • All rights reserved</p>
  </div>
</div>
{{-- Modal --}}
    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form action="{{ route('pekat.login') }}" method="POST">
          ...
          <button type="submit" class="btn btn-purple mt-3 text-white" style="width: 100%">MASUK</button>
        </form>
